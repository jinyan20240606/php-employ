...
class Admin extends BaseApi
{
    ...
    public function index()
    {
        ...
        // ON t1.role_id = t2.id：	外连接的必备关联条件，管理员表的 role_id 关联角色表的 id
        // WHERE username LIKE '%a%' 是select的筛选条件：筛选外连接结果中用户名中包含字母 a 的管理员
        // limit：从第0开始取2条
    ...
    public function save(Request $request)
    {
        ...
        $validate = $this->validate($params, [
            'username|用户名' => 'require|unique:admin',// 唯一性验证，检查 admin 表中 username 字段是否已存在
