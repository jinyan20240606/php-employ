...
//        if (is_null($this->pathinfo)) { wang change
            ...
            if (isset($_REQUEST['argv_rpc']) && defined('RPC_RUN') && RPC_RUN == true) {
                $_SERVER['PATH_INFO'] = $_REQUEST['argv_rpc']; //wang change
            }
            // 分析PATHINFO信息
...
//        if (is_null($this->path)) {wang change
